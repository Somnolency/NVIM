...
_G.packer_plugins = {
  ...
  ["aleph-nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/aleph-nvim",
  ...
  ["cmp-tabnine"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/cmp-tabnine",
  ...
  fd = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/fd",
  ...
  ["surround.nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/surround.nvim",
  ...
  vimcdoc = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vimcdoc",
